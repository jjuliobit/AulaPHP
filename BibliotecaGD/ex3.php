...
$img = imagecreatefromjpeg("image/certificado.jpg");
...
imagettftext($img, 32, 0, 450, 150, $titleColor, $font1, "CERTIFICADO");

imagettftext($img, 25, 0, 440, 350, $titleColor, $font2, "Julio Alves");
